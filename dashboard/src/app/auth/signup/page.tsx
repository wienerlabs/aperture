    ...
    <div className="relative flex min-h-screen items-center justify-center px-4 bg-[#090600]">
      ...
      >
        ...
        <button
          ...
          disabled={isAnyLoading}
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-amber-400/40 px-4 py-2.5 font-mono text-sm text-amber-400 transition-colors hover:bg-amber-400/10 disabled:opacity-50 disabled:hover:bg-transparent"
        >
          {isGoogleLoading ? (
            <LoadingSpinner />
          ) : (
