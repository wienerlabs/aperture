...
export default function SignInPage() {
  ...
  const isAnyLoading = isCredentialLoading || isGoogleLoading || isWalletLoading;
    ...
    <div className="relative flex min-h-screen items-center justify-center px-4 bg-[#000000]">
      ...
      >
        ...
        <button type="button" onClick={handleGoogleSignIn} disabled={isAnyLoading}
          ...
          {isGoogleLoading ? <LoadingSpinner /> : <><GoogleIcon /> Continue with Google</>}
        </button>

        <button type="button" onClick={() => openWalletModal(true)} disabled={isAnyLoading}
          className="mt-3 flex w-full items-center justify-center gap-2 rounded-lg border border-amber-400/40 px-4 py-2.5 font-mono text-sm text-amber-400 transition-colors hover:bg-amber-400/10 disabled:opacity-50">
