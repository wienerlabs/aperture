...
// Vendored from @react-bits/LaserFlow-TS-CSS via shadcn registry. The
// upstream uses `any` casts for THREE uniform refs and pointer event
// callbacks; we ship it as-is to keep the upgrade path painless.
